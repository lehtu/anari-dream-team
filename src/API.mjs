...
export const API = {
    ...
    getSkatersByTeamAbbrev: async (teamAbbrev) => {
        const uri = `https://api.nhle.com/stats/rest/en/skater/bios?cayenneExp=seasonId=20232024 and gameTypeId=2 and teamAbbrevs="${teamAbbrev}"&limit-1`;
        const response = await fetch(uri);
        const result = await response.json();
    ...
    getGoaliesByTeamAbbrev: async (teamAbbrev) => {
        const uri = `https://api.nhle.com/stats/rest/en/goalie/bios?cayenneExp=seasonId=20232024 and gameTypeId=2 and teamAbbrevs="${teamAbbrev}"&limit-1`;
        const response = await fetch(uri);
        const result = await response.json();
    ...
    getPlayersByTeamAbbrev: async (teamAbbrev) => {
        const skaters = await API.getSkatersByTeamAbbrev(teamAbbrev);
        const goalies = await API.getGoaliesByTeamAbbrev(teamAbbrev);
