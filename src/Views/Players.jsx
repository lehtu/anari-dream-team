    ...
    return (
        <div className="players">
            ...
            <div className="filters">
                ...
                <a href={(team.forwards.length + team.defensemen.length + team.goalies.length === 6) && `https://github.com/lehtu/anari-dream-team/issues/new?title=team%20name&labels=my-anari-team&body=${getURIEncodedTeams()}`} target="_blank" className={(team.forwards.length + team.defensemen.length + team.goalies.length === 6) ? 'teamsubmit team-ready' : 'teamsubmit team-not-ready'}>
